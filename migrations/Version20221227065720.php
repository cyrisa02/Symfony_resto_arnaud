 ...
 */
final class Version20221227065720 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu_option (menu_id INT NOT NULL, option_id INT NOT NULL, INDEX IDX_89C15868A7C41D6F (option_id), INDEX IDX_89C15868CCD7E912 (menu_id), PRIMARY KEY(menu_id, option_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
